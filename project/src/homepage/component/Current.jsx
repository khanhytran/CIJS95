...
const Current = (props) => {
    ...
    return (
        <div className='w-4/12'>
            <div className={`cursor-pointer relative rounded-lg overflow-hidden border-2 border-gray-100 ${props.isActive ? 'bg-blue' : 'bg-white'}`} onClick={props.handleClick}>
                ...
                <div className="relative py-3 pl-6 text-left">
                    ...
                    <p className={`w-max pr-5 md:pr-4 sm:mt-1 text-gray-800 font-medium ${props.isActive ? 'text-white' : 'text-gray-800'}`}>{props.description}</p>
                </div>
            </div>
