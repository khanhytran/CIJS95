...
export default function Hero() {
  return (
    <div className='bg-light-blue mb-20l'>
      <div className="relative flex flex-row md\:px-20 sm\:flex-row px-5 py-10 ">
        <div className="left md\:px-20 px-5 py-10 mx-auto flex w-full justify-center items-center">
        ...
        <div className="right mt-10 flex lg\:w-7\/12 items-center overflow-hidden w-full">
          <SliderBanner />
        </div>
      </div>
    </div>
